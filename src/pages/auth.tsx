...
const Auth = () => {
	...
	const bg = 'https://source.unsplash.com/random?wallpapers'
	...
	return (
		<div className='relative flex h-screen w-screen flex-col md:items-center md:justify-center bg-black md:bg-transparent'>
			...
			<Image src={'/test.jpg'} alt={'bg'} fill className='object-cover -z-10 !hidden sm:!inline' />

			<Image //https://rb.gy/p2hphi
				src={'/logo.svg'}
				alt={'logo'}
				width={70}
				height={70}
